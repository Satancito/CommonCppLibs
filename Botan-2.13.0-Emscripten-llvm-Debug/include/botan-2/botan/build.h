...
* 'configure.py --cc=clang --cpu=llvm --os=emscripten --debug-mode --without-documentation --prefix=/Temp/Botan/dist/Botan-2.12.1-Emscripten-llvm-Debug'
*
* Target
*  - Compiler: /WebAssembly/emsdk/upstream/emscripten/em++  -std=c++11 -D_REENTRANT -g -emit-llvm -fno-use-cxa-atexit
*  - Arch: llvm
*  - OS: emscripten
*/
...
#define BOTAN_VERSION_DATESTAMP 20191014
...
#define BOTAN_INSTALL_PREFIX R"(/Temp/Botan/dist/Botan-2.12.1-Emscripten-llvm-Debug)"
#define BOTAN_INSTALL_HEADER_DIR "include/botan-2"
#define BOTAN_INSTALL_LIB_DIR "/Temp/Botan/dist/Botan-2.12.1-Emscripten-llvm-Debug/lib"
...
#define BOTAN_TARGET_ARCH_IS_LLVM
