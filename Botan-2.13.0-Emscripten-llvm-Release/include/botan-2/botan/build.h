...
* 'configure.py --cc=clang --cpu=llvm --os=emscripten --without-documentation --prefix=/Temp/Botan/dist/Botan-2.12.1-Emscripten-llvm-Release'
*
* Target
*  - Compiler: /WebAssembly/emsdk/upstream/emscripten/em++  -std=c++11 -D_REENTRANT -O3 -emit-llvm -fno-use-cxa-atexit
*  - Arch: llvm
*  - OS: emscripten
*/
...
#define BOTAN_INSTALL_PREFIX R"(/Temp/Botan/dist/Botan-2.12.1-Emscripten-llvm-Release)"
#define BOTAN_INSTALL_HEADER_DIR "include/botan-2"
#define BOTAN_INSTALL_LIB_DIR "/Temp/Botan/dist/Botan-2.12.1-Emscripten-llvm-Release/lib"
